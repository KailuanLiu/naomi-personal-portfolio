  ...
  return (
    <header className={`${style.navbar} font-mono`}>
      <div className={style.left}>
        <Link href="/">HOME</Link>
        <a href="https://github.com/KailuanLiu" target="_blank" rel="noopener noreferrer">GITHUB</a>
        <a href="https://www.linkedin.com/in/kailuanliu/" target="_blank" rel="noopener noreferrer">LINKEDIN</a>
      </div>
